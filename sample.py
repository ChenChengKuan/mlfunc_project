...
def sample(ref_file_name, output_path, sample_percentage):
    ...
    save_path_labelled = os.path.join(output_path, "{}_labelled_{}.h5ad".format(ref_file_name_output, int(100 * sample_percentage)))
    save_path_unlabelled = os.path.join(output_path, "{}_unlabelled_{}.h5ad".format(ref_file_name_output, int(100 *  sample_percentage)))
